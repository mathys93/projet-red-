...
func (l *lazyImage) get(data []byte) image.Image {
	l.once.Do(func() {
...
var titleImage, subtitleImage lazyImage

func Title() image.Image {
	return titleImage.get(assets.TitlePNG)
}

func Subtitle() image.Image {
	return subtitleImage.get(assets.SubtitlePNG)
}

var registry = map[string]string{
	"dio":     assets.DioArt,
	"diavolo": assets.DiavoloArt,
	"kira":    assets.KiraArt,
	"pucci":   assets.PucciArt,
	"iggy":    assets.IggyArt,
	"shop":    assets.ShopArt,
}
